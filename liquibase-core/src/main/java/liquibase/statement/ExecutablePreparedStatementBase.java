...
public abstract class ExecutablePreparedStatementBase implements ExecutablePreparedStatement {
    ...
    public void execute(PreparedStatementFactory factory) throws DatabaseException {
        ...
        try {
            ...
            // trigger execution
            executePreparedStatement(stmt, sql);
    ...
    //@TODO: APPDBD - overloaded method to print results
    protected void executePreparedStatement(PreparedStatement stmt, String sql) throws SQLException {
        //stmt.execute();
